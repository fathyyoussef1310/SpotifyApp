          ...
          Align(
              ...
              child: Column(
                children: [
                  ...
                  Padding(
                    padding:  REdgeInsets.all(10.0),
                    child: Customtextformfield(hint: "Password", label: "Password", color:ColorsManager.whiteGrey,suffixIcon: Icons.visibility_off),
                  ),
                    ...
                    child: Row(
                      children: [
                        Expanded(
                          ...
                          }, title: "Sign Up", backgroundColor: ColorsManager.green, foregroundColor: ColorsManager.white),
                        ),
                      ],
                    ),
                  ),
